...
const navItems = [
  { name: "Dashboard", path: "/student-dashboard", icon: <LayoutDashboard className="text-indigo-400" size={18} /> },
...
export const StudentSideNav = ({ onNavItemClick }: { onNavItemClick?: () => void }) => {
