...
const navItems = [
  { name: "Dashboard", path: "/owner-dashboard", icon: <LayoutDashboard className="text-indigo-400" size={18} /> },
  { name: "My Hostels", path: "my-hostels", icon: <Building2 className="text-blue-400" size={18} /> },
  { name: "Room Inventory", path: "rooms", icon: <BedDouble className="text-pink-500" size={18} /> },
  { name: "Media Gallery", path: "media", icon: <ImageIcon className="text-green-400" size={18} /> },
...
export const OwnerSideNav = ({ onNavItemClick }: { onNavItemClick?: () => void }) => {
